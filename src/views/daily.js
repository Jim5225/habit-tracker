    ...
    container.innerHTML = `
      <div class="view-container">
        ...
        <div style="margin-bottom: 32px;">
          <!-- Preparation Countdown Widget expanded -->
          <div class="card" style="position: relative; display:flex; flex-direction:column; justify-content:space-between; max-width: 800px;">
            <div>
        ...
        <h2>Pomodoro Habits (Manual Log)</h2>
